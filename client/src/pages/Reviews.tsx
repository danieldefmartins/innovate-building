...
const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    text: "Built our dream home from the ground up. Mendes was involved in every detail — from foundation to final trim. The communication throughout the entire build was exceptional. You can tell this team takes pride in their work.",
    rating: 5,
    date: "August 2025",
    source: "Google",
  },
